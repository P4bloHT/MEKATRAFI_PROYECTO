...
namespace MecaTrafiSystemGUIApp {
	...
	/// <summary>
	/// Resumen de rodrodillos
	/// </summary>
	public ref class rodrodillos : public System::Windows::Forms::Form
	{
	public:
		rodrodillos(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(rodrodillos::typeid));
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(172, 414);
			...
			this->label10->Location = System::Drawing::Point(96, 415);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(418, 427);
			this->label9->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(343, 51);
			this->label9->TabIndex = 114;
			this->label9->Text = L"Estos rodamientos utilizan cilindros en lugar de bolas\r\n para soportar cargas más"
				L" pesadas y distribuir mejor\r\n la carga sobre una superficie.";
			// 
			// label8
			// 
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->Location = System::Drawing::Point(417, 394);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(96, 359);
			...
			this->button1->Location = System::Drawing::Point(100, 470);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(417, 352);
			this->label6->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(244, 17);
			this->label6->TabIndex = 110;
			this->label6->Text = L"* Velocidad de rotación : 14,000 RPM";
			// 
			// label5
			// 
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(417, 316);
			this->label5->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(103, 17);
			this->label5->TabIndex = 109;
			this->label5->Text = L"* Ancho: 14mm";
			// 
			// label4
			// 
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(417, 281);
			this->label4->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(175, 17);
			this->label4->TabIndex = 108;
			this->label4->Text = L"* Diametro exterior : 47mm";
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(417, 243);
			this->label3->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(176, 17);
			this->label3->TabIndex = 107;
			this->label3->Text = L"*  Diametro interior : 20mm";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Constantia", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(418, 199);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Century Gothic", 16, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(417, 130);
			this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(277, 52);
			this->label1->TabIndex = 105;
			this->label1->Text = L"Rodamiento de rodillos : \r\nNTN NJ204E";
			// 
			// pictureBox1
			// 
			this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.Image")));
			this->pictureBox1->Location = System::Drawing::Point(83, 149);
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &rodrodillos::pictureBox1_Click);
			// 
			// rodrodillos
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(803, 641);
			...
			this->Name = L"rodrodillos";
			this->Text = L"rodrodillos";
			this->Load += gcnew System::EventHandler(this, &rodrodillos::rodrodillos_Load);
...
#pragma endregion
	private: System::Void rodrodillos_Load(System::Object^ sender, System::EventArgs^ e) {
	}
