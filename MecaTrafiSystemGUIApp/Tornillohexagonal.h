...
namespace MecaTrafiSystemGUIApp {
	...
	/// <summary>
	/// Resumen de Tornillohexagonal
	/// </summary>
	public ref class Tornillohexagonal : public System::Windows::Forms::Form
	{
	public:
		Tornillohexagonal(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Tornillohexagonal::typeid));
			...
			this->pictureBox1->Location = System::Drawing::Point(75, 64);
			this->pictureBox1->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(135, 167);
			...
			this->label1->Location = System::Drawing::Point(374, 48);
			this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(330, 26);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Tornillo de cabeza hexagonal";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Constantia", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(376, 98);
			this->label2->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(129, 19);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Especificaciones :";
			this->label2->Click += gcnew System::EventHandler(this, &Tornillohexagonal::label2_Click);
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(375, 142);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(375, 180);
			this->label4->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(96, 17);
			this->label4->TabIndex = 4;
			this->label4->Text = L"* Tamaño: M8";
			// 
			// label5
			// 
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(375, 214);
			this->label5->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(126, 17);
			this->label5->TabIndex = 5;
			this->label5->Text = L"* Longitud : 30mm ";
			// 
			// label6
			// 
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(375, 251);
			...
			this->button1->Location = System::Drawing::Point(58, 369);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(55, 258);
			this->label7->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(158, 17);
			this->label7->TabIndex = 8;
			this->label7->Text = L"Precio Unitario : S/.1.00";
			// 
			// label8
			// 
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->Location = System::Drawing::Point(375, 293);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(375, 326);
			this->label9->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(350, 17);
			this->label9->TabIndex = 10;
			this->label9->Text = L"Tornillo que posee una cabeza en forma de hexágono";
			this->label9->Click += gcnew System::EventHandler(this, &Tornillohexagonal::label9_Click);
			// 
			// label10
			// 
			...
			this->label10->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label10->Location = System::Drawing::Point(55, 314);
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(130, 313);
			...
			this->ClientSize = System::Drawing::Size(737, 498);
			...
			this->Name = L"Tornillohexagonal";
			this->Text = L"Tornillohexagonal";
