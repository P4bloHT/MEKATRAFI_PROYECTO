...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(ventapolea::typeid));
			...
			this->panelmotores->Size = System::Drawing::Size(286, 758);
			this->panelmotores->TabIndex = 5;
			// 
			// pictureBox3
			// 
			this->pictureBox3->BorderStyle = System::Windows::Forms::BorderStyle::Fixed3D;
			this->pictureBox3->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox3.Image")));
			this->pictureBox3->Location = System::Drawing::Point(48, 328);
			this->pictureBox3->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pictureBox3->Name = L"pictureBox3";
			this->pictureBox3->Size = System::Drawing::Size(164, 130);
			...
			// numericUpDown2
			// 
			this->numericUpDown2->Location = System::Drawing::Point(588, 305);
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(588, 34);
			...
			this->pictureBox5->Location = System::Drawing::Point(776, 298);
			...
			this->pictureBox4->Location = System::Drawing::Point(776, 25);
			...
			this->label9->Location = System::Drawing::Point(310, 345);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Constantia", 12, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->Location = System::Drawing::Point(310, 65);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Sitka Small", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(315, 298);
			this->label2->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(211, 35);
			this->label2->TabIndex = 180;
			this->label2->Text = L"Polea sin Piñón";
			this->label2->Click += gcnew System::EventHandler(this, &ventapolea::label2_Click);
			// 
			// label1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Sitka Small", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(310, 28);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(216, 35);
			this->label1->TabIndex = 179;
			this->label1->Text = L"Polea con Piñón";
			// 
			// label6
			// 
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(664, 177);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(247, 25);
			this->label6->TabIndex = 198;
			this->label6->Text = L"* Diametro de eje : 2.55mm";
			// 
			// label5
			// 
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(664, 120);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(216, 25);
			this->label5->TabIndex = 197;
			this->label5->Text = L"* Ancho de paso: 3mm ";
			// 
			// label4
			// 
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(312, 178);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(277, 25);
			this->label4->TabIndex = 196;
			this->label4->Text = L"* Diametro Externo Útil : 13mm";
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(312, 120);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(250, 25);
			this->label3->TabIndex = 195;
			this->label3->Text = L"*  Diametro Externo : 16mm";
			// 
			// label7
			// 
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(646, 455);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(247, 25);
			this->label7->TabIndex = 202;
			this->label7->Text = L"* Diametro de eje : 1.95mm";
			// 
			// label10
			// 
			...
			this->label10->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label10->Location = System::Drawing::Point(646, 398);
			this->label10->Name = L"label10";
			this->label10->Size = System::Drawing::Size(232, 25);
			this->label10->TabIndex = 201;
			this->label10->Text = L"* Ancho de paso: 2.5mm ";
			// 
			// label11
			// 
			...
			this->label11->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label11->Location = System::Drawing::Point(312, 458);
			this->label11->Name = L"label11";
			this->label11->Size = System::Drawing::Size(293, 25);
			this->label11->TabIndex = 200;
			this->label11->Text = L"* Diametro Externo Útil : 5.60mm";
			// 
			// label12
			// 
			...
			this->label12->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label12->Location = System::Drawing::Point(312, 398);
			this->label12->Name = L"label12";
			this->label12->Size = System::Drawing::Size(239, 25);
			this->label12->TabIndex = 199;
			this->label12->Text = L"*  Diametro Externo : 9mm";
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(951, 645);
