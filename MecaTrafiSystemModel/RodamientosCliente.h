...
namespace MecaTrafiSystemModel {
    ...
    public:
        ...
        RodamientosCliente() {}
        RodamientosCliente(int id, String^ name, String^ description, double unitaryPrice, int stock, array<Byte>^ photo, String^ brand, String^ model, String^  component_code,
